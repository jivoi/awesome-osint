...
* [AI-Entropy-Mapper](https://github.com/bad-antics/ai-entropy-mapper) - AI detection and network mapping tool with entropy analysis, perplexity scoring, behavioral fingerprinting, and prompt injection scanning.
