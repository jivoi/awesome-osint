...
* [Watchboard](https://github.com/ArtemioPadilla/watchboard)  - Open-source multi-topic intelligence dashboard platform with interactive maps, 3D globe, source tier classification, and nightly AI-powered updates across 48 topics.
