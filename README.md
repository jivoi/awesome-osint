...
* [Iran.skill](https://github.com/Future3lab/iran-skill) - Open-source AI geopolitical analysis framework for the 2026 Iran crisis. 119 structured files: 21 distilled analyst frameworks, 12 decision-maker models, 7 Persian empire mental models, US war patterns, multi-agent debate protocol. Designed for Claude but model-agnostic.
